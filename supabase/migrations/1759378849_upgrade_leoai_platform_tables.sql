...
-- Created at: 1759378849

-- Migration: upgrade_leoai_platform_tables
-- Created at: 1758981125
...
CREATE TABLE IF NOT EXISTS website_stats (
    ...
    total_bp_analysis INTEGER DEFAULT 0,
    avg_response_time DECIMAL(10,2) DEFAULT 0.0,
    created_at TIMESTAMPTZ DEFAULT NOW()
);

-- 插入初始统计数据
INSERT INTO website_stats (total_users, total_qa, total_bp_analysis, avg_response_time)
VALUES (12580, 3240, 123, 8.3)
