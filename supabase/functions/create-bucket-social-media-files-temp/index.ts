...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'social-media-files',
        name: 'social-media-files',
        public: true
    };
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for social-media-files" ON storage.objects FOR SELECT USING (bucket_id = 'social-media-files');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for social-media-files" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'social-media-files');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for social-media-files" ON storage.objects FOR UPDATE USING (bucket_id = 'social-media-files');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for social-media-files" ON storage.objects FOR DELETE USING (bucket_id = 'social-media-files');`
    ];
