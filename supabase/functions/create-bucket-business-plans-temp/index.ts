...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for business-plans" ON storage.objects FOR SELECT USING (bucket_id = 'business-plans');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for business-plans" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'business-plans');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for business-plans" ON storage.objects FOR UPDATE USING (bucket_id = 'business-plans');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for business-plans" ON storage.objects FOR DELETE USING (bucket_id = 'business-plans');`
    ];
