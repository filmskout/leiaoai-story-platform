        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="relative">
              <Mail className={cn(
                "absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 pointer-events-none z-10",
              ...
              <input
                ...
                className={cn(
                  "pl-11 w-full px-3 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors",
                  actualTheme === 'dark'
