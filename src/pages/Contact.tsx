...
const Contact: React.FC = () => {
  ...
  const getMapConfig = (officeType: 'shenzhen' | 'hong_kong' | 'san_jose') => {
    ...
    const configs = {
      shenzhen: {
        // Sunshine Financial Tower, Nanshan, Shenzhen, China - 使用Google Maps搜索URL
      ...
      hong_kong: {
        // The Hive, 21/F, The Phoenix, 23 Luard Rd, Wan Chai, Hong Kong - 使用Google Maps搜索URL
      ...
      san_jose: {
        // 1814 Brighten Avenue, San Jose, CA95124, USA - 使用Google Maps搜索URL
