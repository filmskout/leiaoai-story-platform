...
const Contact: React.FC = () => {
  ...
  const getMapConfig = (officeType: 'shenzhen' | 'hong_kong' | 'san_jose') => {
    ...
    const configs = {
      shenzhen: {
        // Sunshine Financial Tower, Nanshan, Shenzhen, China - 使用Google Maps Embed API
        google: googleMapsApiKey 
          ? `https://www.google.com/maps/embed/v1/place?key=${googleMapsApiKey}&q=Sunshine+Financial+Tower,+Nanshan,+Shenzhen,+China&zoom=16`
      ...
      hong_kong: {
        // The Hive, 21/F, The Phoenix, 23 Luard Rd, Wan Chai, Hong Kong - 使用Google Maps Embed API
        google: googleMapsApiKey 
          ? `https://www.google.com/maps/embed/v1/place?key=${googleMapsApiKey}&q=The+Hive,+21/F,+The+Phoenix,+23+Luard+Rd,+Wan+Chai,+Hong+Kong&zoom=16`
      ...
      san_jose: {
        // 1814 Brighten Avenue, San Jose, CA95124, USA - 使用Google Maps Embed API
        google: googleMapsApiKey 
          ? `https://www.google.com/maps/embed/v1/place?key=${googleMapsApiKey}&q=1814+Brighten+Avenue,+San+Jose,+CA95124,+USA&zoom=16`
