...
-- Enhanced with detailed research and accurate data
-- ============================================================

BEGIN;

-- Giants (上市公司/独角兽) - 有明确公开数据
...
UPDATE companies SET founded_year = COALESCE(founded_year, 1998), headquarters = COALESCE(headquarters, 'Mountain View, California, USA') WHERE name IN ('Google DeepMind', 'Google');
UPDATE companies SET founded_year = COALESCE(founded_year, 1975), headquarters = COALESCE(headquarters, 'Redmond, Washington, USA') WHERE name IN ('Microsoft AI', 'Microsoft');
UPDATE companies SET founded_year = COALESCE(founded_year, 2004), headquarters = COALESCE(headquarters, 'Menlo Park, California, USA') WHERE name IN ('Meta AI', 'Meta');
UPDATE companies SET founded_year = COALESCE(founded_year, 1994), headquarters = COALESCE(headquarters, 'Seattle, Washington, USA') WHERE name IN ('Amazon AI', 'Amazon');
UPDATE companies SET founded_year = COALESCE(founded_year, 1976), headquarters = COALESCE(headquarters, 'Cupertino, California, USA') WHERE name IN ('Apple AI', 'Apple');
UPDATE companies SET founded_year = COALESCE(founded_year, 2012), headquarters = COALESCE(headquarters, 'Beijing, China') WHERE name = 'ByteDance AI';
UPDATE companies SET founded_year = COALESCE(founded_year, 2000), headquarters = COALESCE(headquarters, 'Beijing, China') WHERE name = 'Baidu AI';
UPDATE companies SET founded_year = COALESCE(founded_year, 1999), headquarters = COALESCE(headquarters, 'Hangzhou, Zhejiang, China') WHERE name = 'Alibaba Cloud AI';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2013), headquarters = COALESCE(headquarters, 'San Francisco, California, USA') WHERE name = 'Notion';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2003), headquarters = COALESCE(headquarters, 'Palo Alto, California, USA') WHERE name IN ('Tesla', 'Tesla AI');
UPDATE companies SET founded_year = COALESCE(founded_year, 2003), headquarters = COALESCE(headquarters, 'Palo Alto, California, USA') WHERE name = 'Argo AI';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2021), headquarters = COALESCE(headquarters, 'San Francisco, California, USA') WHERE name IN ('Invoke AI', 'Chroma');
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2011), headquarters = COALESCE(headquarters, 'Armonk, New York, USA') WHERE name = 'IBM Watson';
UPDATE companies SET founded_year = COALESCE(founded_year, 2010), headquarters = COALESCE(headquarters, 'San Francisco, California, USA') WHERE name = 'Kaggle';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2018), headquarters = COALESCE(headquarters, 'Palo Alto, California, USA') WHERE name = 'Comet ML';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2023), headquarters = COALESCE(headquarters, 'Palo Alto, California, USA') WHERE name = 'Banana';
...
UPDATE companies SET founded_year = COALESCE(founded_year, 2016), headquarters = COALESCE(headquarters, 'San Francisco, California, USA') WHERE name = 'TornadoVM';
...
SELECT 
    ...
    ROUND(COUNT(founded_year)::numeric / COUNT(*) * 100, 2) as pct_complete
FROM companies;
